...
sed -i "/^# From oslo.db/a\connection = mysql+pymysql://$NEU_DBUSER:$NEU_DBPASS@$CONTROLLER_NODE/keystone" \
...
/etc/neutron/neutron.conf
sed -i "/^#type_drivers = local,flat,vlan,gre,vxlan,geneve/a\type_drivers = flat,vlan\ntenant_network_types =\nmechanism_drivers = linuxbridge\nextension_drivers = port_security" \
